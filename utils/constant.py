...
CORS_ORIGINS = os.getenv(
    "CORS_ORIGINS", 
    "http://localhost:3000,http://localhost:3001,http://127.0.0.1:3000,http://127.0.0.1:3001,https://interviewcoach-ai-frontend-sb7x.vercel.app,https://interviewcoach-ai-frontend-chi.vercel.app"
).split(",")
